...
export default function Results() {
  ...
  if (!results) return (
    <div style={{ textAlign: 'center', padding: '80px', color: '#fff' }}>
      No results.
      <button onClick={() => navigate('/analyze')} style={{ color: '#6c63ff', background: 'none', border: 'none', cursor: 'pointer' }}>
        Go back
      </button>
    </div>
  )
      ...
      <div style={{ maxWidth: '820px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={box}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '12px' }}>
            {[
              ...
              ['Keywords', results.keyword_match],
              ['Experience', results.experience_match],
              ['Interview Ready', results.interview_readiness]
            ].map(([l, v]) => (
              <div key={l} style={{
                textAlign: 'center',
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px' }}>
          <div style={box}>
            <h3 style={{
              ...
              color: '#43e97b', textTransform: 'uppercase'
            }}>
              ✅ Strengths
            </h3>
        ...
        <div style={box}>
          ...
          <p style={{
            ...
            color: 'rgba(255,255,255,0.3)', marginBottom: '8px', textTransform: 'uppercase'
          }}>
            Matched
          </p>
          <div style={{ marginBottom: '16px' }}>
            {results.matched_skills?.map((s, i) => (
              <span key={i} style={{
                ...
                borderRadius: '20px', fontSize: '12px', margin: '3px'
              }}>
                {s}
              </span>
            ))}
        ...
        <div style={box}>
          ...
          {results.suggestions?.map((s, i) => (
            <div key={i} style={{
              ...
              borderBottom: i < results.suggestions.length - 1
